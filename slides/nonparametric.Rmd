...
> * This is usually interpreted to mean wr assume the same shape distribution, and the medians are the same.
...
$H$ is distributed as a chi square distribution with $n-1$ degrees of freedom
